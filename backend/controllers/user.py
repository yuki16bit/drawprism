        ...
        if user is not None:
          ...
          if all((new_name, new_email, new_password)):
            if query_user_email(new_email):
              ...
              raise TypeError(
                  'Sign up failed: Password must be 8 to 16 characters with at least 1 digit, 1 uppercase and 1 lowercase letter.')
    ...
    try:
      ...
      if all((email, password)):
        if not validate_email(email):
          ...
          raise TypeError(
              'Sign in failed: Password must be 8 to 16 characters with at least 1 digit, 1 uppercase and 1 lowercase letter.')
